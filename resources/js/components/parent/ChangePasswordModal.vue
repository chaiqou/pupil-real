        ...
        >
          ...
          >
            ...
            >
              ...
              <ValidationForm @submit="onSubmit" class="flex justify-center flex-col items-center">
                  <div class="flex flex-col justify-around h-[10rem]">
                     <div>
                      ...
                      <div>
                          ...
                          <div class="mt-1">
                              <Field
                                  :rules="{confirmed: { target: this.password }, required: true }"
                                  type="password"
                          ...
                          <div class="absolute">
                              <ErrorMessage name="confirmation" class="text-sm text-red-500">
                              </ErrorMessage>
                          </div>
                      </div>
                  </div>
                  <div class="flex items-center justify-center">
                      <div class="flex-1">
                          <button class="inline-flex mt-7 justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm min-w-full">
             <span class="flex items-center">
                   Save
            <SpinnerAnimation v-if="passwordUpdatingStatus === 'ongoing'" class="absolute"></SpinnerAnimation>
            <CheckIcon v-if="passwordUpdatingStatus === 'updated'" class="h-6 w-6 text-green-500"></CheckIcon>
            <XMarkIcon v-if="passwordUpdatingStatus === 'error'" class="w-6 h-6 text-red-500"></XMarkIcon>
          </span>
                          </button>
                      </div>
                  </div>
  ...
  methods: {
    ...mapActions(useModalStore, ["showHideChangePassword"]),
     onSubmit(values, actions) {
       ...
       axios.post(`/api/parent/update-password/${this.user_id}`, {

<template>
  ...
  <div>
    ...
    >
      {{ $t("message.fill_out_your_personal_information") }}
    </h2>
  </div>

  <div>
    <ValidationForm @submit="onSubmit" class="mt-8 space-y-6 lg:w-[35rem]">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      axios
        .post(`/api/merchant-personal-form/${this.uniqueId}`, {

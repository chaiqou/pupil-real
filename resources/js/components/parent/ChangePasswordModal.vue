<template>
    <div class="m-3 text-white rounded-md">
        <button @click="showHideChangePassword()" class="p-2.5 shadow-sm border border-transparent bg-indigo-600 rounded-md hover:bg-indigo-700">Change Password</button>
    </div>

...
<body class="h-full">
    <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-xl space-y-8 flex items-center justify-center flex-col" data-sal="slide-left" data-sal-duration="500" data-sal-delay="200">
            ...
            @enderror
            <div class="w-full">
                <form id="form" method="POST" action="{{route('merchant-company.details_submit',['uniqueID'=>$uniqueID])}}" class="mt-8 space-y-6">
                    @csrf
                    <div class="bg-white p-8">
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="text" value="{{old('merchant_nick')}}" required name="merchant_nick" id="merchant_nick" autocomplete="merchant-nick" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="text" value="{{old('company_name')}}" name="company_name" id="company_name" autocomplete="company-name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="text" value="{{old('VAT')}}" name="VAT" id="VAT" autocomplete="VAT" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                            </div>
                        </div>
                        <div class="pt-5">

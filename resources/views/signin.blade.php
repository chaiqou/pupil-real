...
<body class="h-full">
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="p-12 max-w-md w-full space-y-8">
            <div>
                <img data-aos="fade-up" class="mx-auto h-20 w-auto" src="{{ asset('img/dash-color.svg') }}"
                    alt="Dash">
                <h2 data-aos="fade-up" data-aos-delay="100"
                    class="mt-6 text-center text-3xl font-extrabold text-gray-900">Sign in to Dash</h2>
                @if ($errors->has('email'))
            ...
            <form data-aos="fade-up" data-aos-delay="200" class="mt-8 space-y-6" action="{{ route('login.post') }}"
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="{{ route('default') }}" class="font-medium text-blue-600 hover:text-blue-500"> Forgot
                            your password? </a>
                    </div>
                </div>

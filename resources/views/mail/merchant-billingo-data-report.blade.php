...
<p>Hello! Im here to report you that merchant which nick is:{{$merchant->merchant_nick}} and id#{{$merchant->id}} doesn't have Billingo data (block_id) from billingo.</p>
</body>
</html>

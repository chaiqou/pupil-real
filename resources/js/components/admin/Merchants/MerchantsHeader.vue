<template>
            ...
            <div class="sm:flex-auto flex items-end justify-between">
                <div>
                    <h1 class="text-xl font-semibold text-gray-900">
                        All Merchants belonging to school #{{this.schoolId}}
                    </h1>
    ...
    <invite-merchant-modal></invite-merchant-modal>
</template>

<script>
import { useModalStore } from "@/stores/useModalStore";
import { mapWritableState, mapActions } from "pinia";
import InviteMerchantModal from "@/components/admin/Merchants/InviteMerchantModal.vue";

        ...
        <div class="w-full max-w-xl space-y-8">
            ...
            <div>
                ...
                <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">
                    ...
                    Fill out the student's personal information
                    @else
                    Töltse ki a diák személyes adatait
                    @endif
                </h2>
            </div>
            @error('*')
                ...
                <div class="bg-white p-8">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            {{auth()->user()->language === 'en' ? 'Use the student's permanent residence' : 'Használja a diák állandó lakcímét'}}.
                        </p>
                    </div>

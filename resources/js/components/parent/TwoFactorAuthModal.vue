<template>
    ...
    <div class="px-8 py-3 bg-white rounded-md w-[15rem]">
        ...
        <button @click="showHideTwoFactor()" class="p-2 mt-4 bg-green-400 rounded-md">{{this.twoFa === true ? 'Activate' : 'Deactivate'}}</button>
    </div>
                        ...
                        <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900">{{this.twoFa === true ? 'Activate' : 'Deactivate'}} 2FA</DialogTitle>
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">Are you sure you want to {{this.twoFa === true ? 'activate' : 'deactivate'}} 2FA?</p>
                                    </div>
                                </div>
                            </div>

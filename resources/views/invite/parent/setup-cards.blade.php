        ...
        <div class="w-full">
            <form id="form" method="POST" action="{{route('parent-setup.cards_submit',['uniqueID'=>$uniqueID])}}" class="space-y-6">
               ...
               <div class="flex w-full bg-black justify-between">
                   ...
                   <button name="user_response" value="dont_save_card" class="inline-flex justify-center rounded-md border border-[1px] bg-white py-2 px-4 text-sm font-medium shadow-sm hover:bg-gray-100 focus:outline-none">Don't save card</button>
               </div>
            </form>
        </div>
        </div>

...
export default {
  ...
  mounted() {
    ...
    if (this.pieChartData.length === 4) {
      this.chartOptions.colors = ["#0061F2", "#2341E4", "#4620D5", "#6900C7"];
    }
    if (this.pieChartData.length === 5) {

<template>
            ...
            <div class="w-full">
<!--                <form id="a" method="POST" action="{{route('parent-setup.account_submit',['uniqueID'=>$uniqueID])}}" class="mt-8 space-y-6">-->

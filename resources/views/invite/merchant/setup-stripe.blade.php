    ...
    <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center">
            <form id="form" method="POST" action="{{route('merchant-setup.stripe_submit',['uniqueID'=>$uniqueID])}}" class="">
                @csrf
                <button class="bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-1.5 rounded-md flex items-center"> Continue on  <img class="w-12 h-12" src="{{asset('img/stripe-white.svg')}}" alt="PupilPay" /></button>
            </form>
        </div>
        </div>
    </div>

<template>
    <TransitionRoot as="template" :show="this.isInviteMerchantVisible">
        <Dialog
            as="div"
            class="relative z-10"
            @close="this.isInviteMerchantVisible = false; this.chosenSchool = null; this.email = null; this.backResponse = null;"
        >
            <TransitionChild
                as="template"
                        ...
                        >
                            ...
                            >
                                <button
                                    ...
                                    @click="this.isInviteMerchantVisible = false; this.chosenSchool = null; this.email = null; this.backResponse = null;"
                                >
                            ...
                            <div class="mt-10">
                                <ValidationForm @submit="onSubmit">
                                       <div class="flex flex-col">
                                           ...
                                           <Field v-slot="{ resetField }" name="email" v-model="email" placeholder="email" type="text" rules="email" autocomplete="email"
                                           ...
                                           <p class="mt-1 text-sm text-red-500">{{this.backResponse}}</p>

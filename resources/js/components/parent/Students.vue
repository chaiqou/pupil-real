<template>
    <table :class="!this.isChangePasswordVisible ? (!this.isTwoFactorVisible ? 'min-w-full divide-y divide-gray-300' :  'hidden min-w-full divide-y divide-gray-300') : 'hidden min-w-full divide-y divide-gray-300'">
